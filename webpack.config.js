...
module.exports = env => {
  // ESM library build configuration
  if (env.target === 'esm') {
    return {
      mode: 'production',
      ...
      output: {
        ...
        filename: 'consent-o-matic.esm.js',
        library: {
          type: 'module',
        },
        globalObject: 'this',
      ...
      optimization: {
        minimize: false, // Keep readable for library consumers
        usedExports: true,
        sideEffects: false
      },
      resolve: {
  ...
  // Original extension build configuration
  return {
    mode: 'production',
    entry: {
